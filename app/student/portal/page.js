      ...
      <main className="max-w-5xl mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
          ...
          <div className="bg-white rounded-xl shadow-md p-4 text-center">
            ...
            <p className="text-2xl font-bold text-purple-600">{stats.signIns}</p>
            <p className="text-sm text-gray-500">Total Sign-Ins</p>
          </div>
        </div>
                ...
                <div key={index} className="p-4 hover:bg-gray-50">
                  ...
                  <div className="mt-3 grid grid-cols-2 gap-4 text-sm">
                    <div className="flex items-center space-x-2">
                      <div className={`w-2 h-2 rounded-full ${record.signIn ? 'bg-green-500' : 'bg-gray-300'}`}></div>
                    ...
                    <div className="flex items-center space-x-2">
                      <div className={`w-2 h-2 rounded-full ${record.signOut ? 'bg-blue-500' : 'bg-gray-300'}`}></div>
                      <span className="text-gray-600">
